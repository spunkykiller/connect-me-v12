  ...
  return (
    <div className="services-dropdown" onClick={(e) => e.stopPropagation()}>
      ...
      <div className="sd-col">
        ...
        <Link to="/services2#utility-maintenance" onClick={handleClick}>
          Utility Meter Maintenance
        </Link>

        <Link to="/services2#billing" onClick={handleClick}>
          Billing Managed Service
        </Link>

        <Link to="/services2#amc" onClick={handleClick}>
          AMC & Training
        </Link>

        <Link to="/services2#consultancy" onClick={handleClick}>
          Technical Consultancy
        </Link>

        <Link to="/services2#plc" onClick={handleClick}>
          PLC & SCADA
        </Link>

        <Link to="/services2#development" onClick={handleClick}>
