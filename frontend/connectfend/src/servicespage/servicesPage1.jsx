...
====================================================== */}
      <section id="remote-connect" className="rc-wrapper">
        ...
        <p className="rc-below">
          ConnectME remote connectivity solutions based on TOSIBOX and EWON devices and both are
          well-known companies in the industrial remote connectivity space. TOSIBOX offers VPN routers
          that provide secure and reliable remote access to industrial networks. EWON, on the other hand,
          offers routers and gateways that enable remote monitoring and control of industrial equipment.
          Both companies have a strong reputation for their reliable and secure solutions.
        </p>
